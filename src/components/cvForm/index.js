...
export default class CVform extends Component {
    ...
    submitCV=()=>{
        ...
        axios.post("/saveCleint",{formdata:{...data}}).then(res=>{
            console.log(res);
        })
        // fetch('/saveCleint', {
        //     method: 'POST',
    ...
    render() {
        return (
            <div   id="career" style={{ backgroundImage: `url(${officeImage})`, height:"100%", width: "100%",
             paddingTop: "3%",marginTop:"5%" }}>
                ...
                <div  class="container" style={{paddingBottom:"3%"}}>
                    <div class="row">
                        <div class="col-sm">
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="name" onChange={this.onChange.bind(this,"phone")}/>
                                </div>
                                <div class="form-group">
                        ...
                        style={{fontSize:28,fontWeight:"bolder",color:"white"}} onClick={this.submitCV}>Submit</button>
                    </div>
                </div>
        )
    }
